...
- **`connector-qa`** — Validate changes: lint, tests (197 cases), Docker build, dev-stack end-to-end enrichment, qa-handoff test matrix. Reports PASS/FAIL/BLOCKED with evidence.
